...
const MeResponse = () => (
  <div className="p-2 sm:p-4">
    ...
    <div className="mb-4 sm:mb-6">
      <p className="text-base sm:text-lg font-semibold">Hey, I'm Ahib 👋</p>
    </div>
    ...
    <div className="flex flex-col items-start mb-4 sm:mb-6" style={{ flexDirection: 'var(--profile-flex-direction, column)', alignItems: 'var(--profile-align-items, center)' }}>
      ...
      <div className="flex-1 w-full">
        ...
        <p className="text-gray-700 text-sm sm:text-base mb-3 sm:mb-4">AI Software Engineer at PRAN-RFL Group | Building RAG & NL→SQL Systems on Enterprise Data (Billions of Rows) | BRAC University | Top 5 (Worldwide) in Mission OZ 2022</p>
